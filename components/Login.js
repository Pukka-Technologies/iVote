...
const Login = () => {
  ...
  return (
    <div class="bg-lime-600   max-w-screen-2xl px-6  m-auto">
...
<div className='pt-2 pb-2'>
  <input id="email" name="email" type="text" class='w-full md:w-[26rem] h-10  outline-none pl-3'/>
</div>
<label for="password" class='text-2xl font-medium font-sans text-slate-900'>Password</label>
<div  className='pt-2'>
  <input id="password" name="password" type="password" class='w-full md:w-[26rem] h-10  outline-none pl-3'/>
</div>
<div>
  <h3 class='pt-5 text-[darkslategray] text-2xl'>Forgot Password?</h3>
</div>
<div class='mt-6'> 
  <button class='bg-[#001212] w-full md:w-64 h-10 text-neutral-200'>LOGIN</button></div>
