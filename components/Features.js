  ...
  return (
    <div className="flex flex-col justify-center items-center font-text pt-20">
      ...
      <div className="grid grid-cols-3 gap-8 px-20">
        ...
        <div className="relative p-10 after:absolute after:block after:content-['02'] after:text-green-100 after:font-extrabold after:text-9xl after:opacity-50 after:bottom-0 after:right-0">
          <p className="w-fit p-3 bg-green-400">
            <BsPhone />
          </p>
          <p>
        ...
        <div className="relative p-10 after:absolute after:block after:content-['03'] after:text-green-100 after:font-extrabold after:text-9xl after:opacity-50 after:bottom-0 after:right-0">
          <p className="w-fit p-3 bg-green-400">
      ...
      <div className="grid grid-cols-3 gap-5 px-20">
        ...
        <div className="relative p-10 after:absolute after:block after:content-['05'] after:text-green-100 after:font-extrabold after:text-9xl after:opacity-50 after:bottom-0 after:right-0">
          <p className="w-fit p-3 bg-green-400">
            <AiOutlineDollar />
          </p>
          <p>
        ...
        <div className="relative p-10 after:absolute after:block after:content-['06'] after:text-green-100 after:font-extrabold after:text-9xl after:opacity-50 after:bottom-0 after:right-0">
          <p className="w-fit p-3 bg-green-400">
            <RiSpeedLine />
          </p>
          <p>
